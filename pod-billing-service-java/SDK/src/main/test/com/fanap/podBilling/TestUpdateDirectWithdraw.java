...
//                    .setScVoucherHash(voucherHashs)
            ...
            billingService.updateDirectWithdraw(updateDirectWithdrawVo, new OnGetResponseListener<DirectWithdrawSrv>() {
                ...
                public void onResponse(ResultVo<DirectWithdrawSrv> result) {
                    ...
                    new Thread(() -> {
                        try {
                            assertEquals("zahraz", result.getResult().getUsername());
...
//                    .setScVoucherHash(voucherHashs)
    ...
    @Test
    public void updateDirectWithdraw_RequiredParameters_UserName() {
        BaseInfoVo baseInfoVo = new BaseInfoVo.Builder()
                .setToken(TOKEN)
                .setToken_issuer(1)
                .setServerType(Enum_Server_type.SANDBOX)
...
//                    .setScVoucherHash(voucherHashs)
    ...
    @Test
    public void updateDirectWithdraw_RequiredParameters_PrivateKey() {
        BaseInfoVo baseInfoVo = new BaseInfoVo.Builder()
                .setToken(TOKEN)
                .setToken_issuer(1)
                .setServerType(Enum_Server_type.SANDBOX)
...
//                    .setScVoucherHash(voucherHashs)
    ...
    @Test
    public void updateDirectWithdraw_RequiredParameters_DepositNumber() {
        BaseInfoVo baseInfoVo = new BaseInfoVo.Builder()
                .setToken(TOKEN)
                .setToken_issuer(1)
                .setServerType(Enum_Server_type.SANDBOX)
...
//                    .setScVoucherHash(voucherHashs)
    ...
    @Test
    public void updateDirectWithdraw_RequiredParameters_OnDemand() {
        BaseInfoVo baseInfoVo = new BaseInfoVo.Builder()
                .setToken(TOKEN)
                .setToken_issuer(1)
                .setServerType(Enum_Server_type.SANDBOX)
...
//                    .setScVoucherHash(voucherHashs)
    ...
    @Test
    public void updateDirectWithdraw_RequiredParameters_MinAmount() {
        BaseInfoVo baseInfoVo = new BaseInfoVo.Builder()
                .setToken(TOKEN)
                .setToken_issuer(1)
                .setServerType(Enum_Server_type.SANDBOX)
...
//                    .setScVoucherHash(voucherHashs)
    ...
    @Test
    public void updateDirectWithdraw_RequiredParameters_MaxAmount() {
        BaseInfoVo baseInfoVo = new BaseInfoVo.Builder()
                .setToken(TOKEN)
                .setToken_issuer(1)
                .setServerType(Enum_Server_type.SANDBOX)
