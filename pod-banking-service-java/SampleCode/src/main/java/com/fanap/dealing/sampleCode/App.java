...
//                .setScVoucherHash(scVoucherHashs)
        ...
        jsonDateContent.setIP("193.148.64.165");
        jsonDateContent.setPlatfrom("WEB");
        jsonDateContent.setOS("Android 4.4.2");
        jsonDateContent.setUserAgent("");
        jsonDateContent.setImei("a58724c6f");
        ...
        try {
            CardToCardVo cardToCardVo = new CardToCardVo.Builder(baseInfoVo)
                    .setUserName("66497service")
                    .setSrcCardNumber("5022291077346508")
                    .setDestCardNumber("6037997256803041")
                    .setPassword("93455")
                    .setCvv2("226")
                    .setExpireMonth("08")
                    .setExpireYear("00")
...
//                .setScVoucherHash(scVoucherHashs)
        ...
        batchPayaItemInfoContents.setBillNumber(1345l);
        ...
        try {
            PayaSeriviceVo payaSeriviceVo = new PayaSeriviceVo.Builder(baseInfoVo)
                    .setUserName("66497service")
                    .setSourceDepositNumber("1001.800.66497.2")
                    .setFileUniqueIdentifier("ACH15AS8d5WP56800")
